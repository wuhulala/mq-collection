...
import static com.wuhulala.rabbitmq.chapter1.exchange.topic.Constants.C_ROUTING_KEY_2;
...
public class TopicConsumer2 {
    ...
    public static void main(String[] args) throws Exception {
        ...
        System.out.println("consumer2 Waiting for msg use routingKey[" + C_ROUTING_KEY_2  + "]");
        //创建消费者，并接受消息
        Consumer consumer = new DefaultConsumer(channel) {
            ...
            public void handleDelivery(String consumerTag, Envelope envelope, AMQP.BasicProperties properties, byte[] body)
                ...
                System.out.println("consumer2 -> Received is = '" + msg + "'");
            }
        };
        channel.queueBind(QUEUE_NAME, TOPIC_EXCHANGE_NAME, C_ROUTING_KEY_2);
